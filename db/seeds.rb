...
@btc = Cryptocurrency.create!(name: 'Bitcoin', symbol: 'BTC',
...
@eth = Cryptocurrency.create!(name: 'Ethereum', symbol: 'ETH',
...
@ada = Cryptocurrency.create!(name: 'Cardano', symbol: 'ADA',
...
@bnb = Cryptocurrency.create!(name: 'Binance Coin', symbol: 'BNB',
...
@usdt = Cryptocurrency.create!(name: 'Tether', symbol: 'USDT',
...
@doge = Cryptocurrency.create!(name: 'Dogecoin', symbol: 'DOGE',
...
@xrp = Cryptocurrency.create!(name: 'XRP', symbol: 'XRP',
...
@ltc = Cryptocurrency.create!(name: 'Litecoin', symbol: 'LTC',
...
@matic = Cryptocurrency.create!(name: 'Polygon', symbol: 'MATIC',
...
@cake = Cryptocurrency.create!(name: 'PancakeSwap', symbol: 'CAKE',
